...
class Log_EweiShopV2Page extends CommissionMobileLoginPage
{
	...
	public function get_list()
	{
        ...
        show_json(1, array('list' => $list, 'commissioncount' => number_format($commissioncount, 2), 'pagesize' => $psize, 'total' => $total, 'pindex' => $pindex, 'total_pages' => max(1,ceil($total/$psize))));
