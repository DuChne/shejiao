...
class Bonus_EweiShopV2Page extends PluginWebPage 
{
	...
	public function build() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			//循环要分的优惠券结算
			foreach($data['jsorders'] as $order)
			{
			    $bo = array('uniacid' => $_W['uniacid'], 'billid' => $billid, 'orderid' => $order['id'], 'ordermoney' => $order['price']);
				pdo_insert('ewei_shop_abonus_billo', $bo);
			}
			...
			{
				$bp = array('uniacid' => $_W['uniacid'], 'billid' => $billid, 'payno' => m('common')->createNO('abonus_billp', 'payno', 'AP'), 'openid' => $a['openid'], 'money1' => $a['bonusmoney1'], 'realmoney1' => $a['bonusmoney_send1'] * $rate1, 'paymoney1' => $a['bonusmoney_send1'] * $rate1, 'realmoney2' => $a['bonusmoney_send2'] * $rate2, 'paymoney2' => $a['bonusmoney_send2'] * $rate2, 'realmoney3' => $a['bonusmoney_send3'] * $rate3, 'paymoney3' => $a['bonusmoney_send3'] * $rate3, 'bonus1' => $a['bonus1'], 'bonus2' => $a['bonus2'], 'bonus3' => $a['bonus3'],'jsbonus'=>$a['jsbonusmoney'], 'charge' => $a['charge'], 'chargemoney1' => $a['chargemoney1'], 'chargemoney2' => $a['chargemoney2'], 'chargemoney3' => $a['chargemoney3'], 'status' => 0);
