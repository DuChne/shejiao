...
class Address_EweiShopV2Page extends MobileLoginPage 
{
    ...
    public function getaddressinfo()
    {
        ...
        global $_GPC;
        $id = intval($_GPC['id']);
        $data = pdo_get('ewei_shop_member_address',['id'=>$id,'uniacid'=>$_W['uniacid'],'openid'=>$_W['openid']],['id','openid','realname','mobile','province','city','area','address']);
        show_json(1,array('addinfo'=>$data));
    }
}
?>