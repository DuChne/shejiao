...
class Apply_EweiShopV2Page extends CommissionMobileLoginPage 
{
	public function main() 
	{
        ...
        $parm = array(
            ...
            'type_array'         =>  $type_array,//提现方式
            'set_array'         =>  $set_array,//提现配置
            'deductionmoney'         =>  $deductionmoney,//扣除佣金
            'realmoney'         =>  $realmoney,//实际到账佣金
            'last_data'         =>  $last_data,//最后一次提现的信息
            'banklist'         =>  $banklist,//可提现银行
