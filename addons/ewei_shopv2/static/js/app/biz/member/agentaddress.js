define(['core', 'tpl'], function (core, tpl) {
        ...
        require(reqParams, function () {
            $('#areas').cityPicker({
                ...
                onClose: function (self) {
					...
					if(displayvalue!='')
					{
						displayvalue1 = displayvalue.toString().replace(/,/g, "");
							core.json('order/create/checkagentarea', {area:displayvalue1}, function (ret) {
								if (ret.status == 0) {
									$('#areas').val();
                    ...
                    if (params.new_area && params.address_street) {
                        ...
                        var street = $('<input type="text" id="street"  name="street" data-value="" value="" placeholder="代理街道"  class="fui-input" readonly=""/>');
    ...
    modal.loadSelectorData = function () {
        core.json('member/address/selector/get_list_agent', {}, function () {})
    };
